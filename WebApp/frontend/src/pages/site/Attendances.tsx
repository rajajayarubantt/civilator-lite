      ...
      >
        <form onSubmit={handleVendorSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
            ...
            >
              Add {activeTab === "vendor_labour" ? "Vendor" : "Labour"}
            </Button>
          </div>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 bg-gray-100 pb-4">
            ...
            <div className="flex flex-col gap-3">
              {VendorMarkAttenData?.labours.map((item: any, index: number) => (
                <div
                  key={index}
        ...
        <form onSubmit={handleLabourSubmit} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
            <FormField
              ...
              onChange={(value) => {
                let selectedLabour = MasterLabours.find((v) => v.id === value);
                setLabourFormData({
                  ...labourFormData,
      ...
      <div className="flex flex-col gap-4">
        <div className="flex pb-4 border-b border-gray-200 gap-4 flex-col md:flex-row md:pb-0 md:items-center md:justify-between">
          ...
          <div className="flex items-center justify-between gap-2 w-full  md:w-max md:justify-end">
            {(activeTab == "all" || activeTab == "my_labour") && (
              <Button
                size="sm"
                variant="primary"
            ...
            {(activeTab == "all" || activeTab == "vendor_labour") && (
              <Button
                size="sm"
                variant="primary"
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-md font-semibold text-gray-900">
              To pay: ₹ {parseFloat(AttendanceSummary.total_payable).toFixed(2)}
            </span>
            <div className="flex items-center gap-2">
        ...
        <div className="w-full mt-4">
          <Table
            ...
            mobileCardSubtitle={(attendance: any) =>
              attendance.type == "vendor_labour"
                ? attendance.labours?.map((l: any) => l.labour_name).join(" | ")
